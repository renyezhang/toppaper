...
class UnifiedNIPSScraper:
    def __init__(self, year: int = 2025):
        ...
        if self.year >= 2023:
            ...
            # v2 使用 venueid
            self.venue_id = f"NeurIPS.cc/{year}/Conference"
        else:
            self.api_version = 1
            ...
            self.invitation_id = f"NeurIPS.cc/{year}/Conference/-/Blind_Submission"

    def get_all_papers(self) -> List[Dict]:
        print(f"开始获取 NeurIPS {self.year} 所有论文 (API v{self.api_version})...")
    ...
    def print_summary(self):
        ...
        print("\n" + "="*50)
        print(f"NeurIPS {self.year} 论文统计")
        print("="*50)
